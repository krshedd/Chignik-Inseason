...
date_2019.df <- tibble(strata = 1, 
                       begin_date = as.Date(x = c("2018-06-25")), 
                       end_date = as.Date(x = c("2018-06-25")))

# Pool
PoolCollectionsByDateDF(silly = "SCHIG18", date.df = date_2019.df, loci = loci24_RAD)
...
sillys_strata_2019 <- setdiff(
  str_replace(string = objects(pattern = "\\.gcl"), 
              ...
              replacement = ''),
  sillys)
save_objects(objects = "sillys_strata_2019", path = "Objects")
