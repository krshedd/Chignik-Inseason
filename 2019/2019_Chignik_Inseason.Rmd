...
FYI, I used the UW pre-season average transition model from "stan" for Run 1 and 2, then switched to the ADF&G model that I got for Dawn for Run 3-6.
...
save_objects(objects = "chignik_2019_dates.bayes", path = "../../2019/Estimates objects/")
write_csv(x = chignik_2019_dates.bayes, path = "../../2019/Estimates tables/Chignik 2019 BAYES Estimates.csv")
```
...
# Strata dates
date_2019.df <- tibble(strata = 1:strata, 
                       begin_date = as.Date(x = c("2019-06-25", "2019-07-01", "2019-07-08", "2019-07-13")), 
                       end_date = as.Date(x = c("2019-06-25", "2019-07-01", "2019-07-08", "2019-07-13")))
...
```{r run4_QA_loci}
## Get sample size by locus
original_sillys_strata_2019_run4_n_locus <- SampSizeByLocus.GCL(sillyvec = sillys_strata, loci = loci24_RAD)
min(original_sillys_strata_2019_run4_n_locus)
round(apply(original_sillys_strata_2019_run4_n_locus, 1, function(locus) {min(locus) / max(locus)}), 2)

original_sillys_strata_percent_locus <- apply(original_sillys_strata_2019_run4_n_locus, 1, function(row) {row / max(row)} )
which(apply(original_sillys_strata_percent_locus, 2, min) < 0.8)  # no re-runs!
...
(
  sillys_strata_2019_n <- sillys_strata_2019_n %>%
    ...
    mutate(final = case_when(
      silly %in% c("SCHIG19_1", "SCHIG19_2", "SCHIG19_4") ~ as.integer(final - 1),
      TRUE ~ final
    ))
)
...
save_objects(objects = "SCHIG19_4_estimates", path = "../../2019/Estimates objects/")
```

Create function to view traceplot
```{r traceplot_run4}
trace_plot.f(estimate_obj = SCHIG19_4_estimates)
```
...
## Prior for next round
```{r prior_run5}
chignik_5_2019_prior <- Prior.GCL(groupvec = groupvec16, groupweights = SCHIG19_4_estimates[[1]][[1]][, 1], minval = 0.01)
save_objects(objects = "chignik_5_2019_prior", path = "../../2019/Objects/")
```

## Save
```{r save_run4}
save.image("../../2019/chignik_2019_run4.RData")
```
...
# Strata dates
date_2019.df <- tibble(strata = 1:strata, 
                       begin_date = as.Date(x = c("2019-06-25", "2019-07-01", "2019-07-08", "2019-07-13", "2019-07-19")), 
                       end_date = as.Date(x = c("2019-06-25", "2019-07-01", "2019-07-08", "2019-07-13", "2019-07-19")))
...
```{r run5_QA_loci}
## Get sample size by locus
original_sillys_strata_2019_run5_n_locus <- SampSizeByLocus.GCL(sillyvec = sillys_strata, loci = loci24_RAD)
min(original_sillys_strata_2019_run5_n_locus)
round(apply(original_sillys_strata_2019_run5_n_locus, 1, function(locus) {min(locus) / max(locus)}), 2)

original_sillys_strata_percent_locus <- apply(original_sillys_strata_2019_run5_n_locus, 1, function(row) {row / max(row)} )
which(apply(original_sillys_strata_percent_locus, 2, min) < 0.8)  # no re-runs!
...
(
  sillys_strata_2019_n <- sillys_strata_2019_n %>%
    ...
    mutate(final = case_when(
      silly %in% c("SCHIG19_1", "SCHIG19_2", "SCHIG19_4") ~ as.integer(final - 1),
      silly == "SCHIG19_5" ~ as.integer(final - 4),
      TRUE ~ final
    ))
)
...
save_objects(objects = "SCHIG19_5_estimates", path = "../../2019/Estimates objects/")
```

Create function to view traceplot
```{r traceplot_run5}
trace_plot.f(estimate_obj = SCHIG19_5_estimates)
```
...
## Prior for next round
```{r prior_run6}
chignik_6_2019_prior <- Prior.GCL(groupvec = groupvec16, groupweights = SCHIG19_5_estimates[[1]][[1]][, 1], minval = 0.01)
save_objects(objects = "chignik_6_2019_prior", path = "../../2019/Objects/")
```

## Save
```{r save_run5}
save.image("../../2019/chignik_2019_run5.RData")
```
...
# Strata dates
date_2019.df <- tibble(strata = 1:strata, 
                       begin_date = as.Date(x = c("2019-06-25", "2019-07-01", "2019-07-08", "2019-07-13", "2019-07-19", "2019-07-26")), 
                       end_date = as.Date(x = c("2019-06-25", "2019-07-01", "2019-07-08", "2019-07-13", "2019-07-19", "2019-07-29")))
...
```{r run6_QA_loci}
## Get sample size by locus
original_sillys_strata_2019_run6_n_locus <- SampSizeByLocus.GCL(sillyvec = sillys_strata, loci = loci24_RAD)
min(original_sillys_strata_2019_run6_n_locus)
round(apply(original_sillys_strata_2019_run6_n_locus, 1, function(locus) {min(locus) / max(locus)}), 2)

original_sillys_strata_percent_locus <- apply(original_sillys_strata_2019_run6_n_locus, 1, function(row) {row / max(row)} )
which(apply(original_sillys_strata_percent_locus, 2, min) < 0.8)  # no re-runs!
...
(
  sillys_strata_2019_n <- sillys_strata_2019_n %>%
    ...
    mutate(final = case_when(
      silly %in% c("SCHIG19_1", "SCHIG19_2", "SCHIG19_4", "SCHIG19_6") ~ as.integer(final - 1),
      silly == "SCHIG19_5" ~ as.integer(final - 4),
      TRUE ~ final
    ))
)
...
save_objects(objects = "SCHIG19_6_estimates", path = "../../2019/Estimates objects/")
```

Create function to view traceplot
```{r traceplot_run6}
trace_plot.f(estimate_obj = SCHIG19_6_estimates)
```
...
table(SCHIG19_6.gcl$attributes$CAPTURE_DATE)
```
...
## Save
```{r save_run6}
save.image("../../2019/chignik_2019_run6.RData")
```
