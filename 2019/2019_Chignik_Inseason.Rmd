...
library(ggpubr)
# library(conflicted)
#library(lubridate) # Chase needed for function yday...

#source("~//R/Functions.GCL.R")
source("C:/R/Functions.GCL.R") # chase added if require coda install to the CustomeCombineBAYESOutput function, do we want to use pacman or something for all GCLs, to avoid issues in future?
.username = "krshedd"
.password = "kokanee"
...
Find and replace "run3" #already done
